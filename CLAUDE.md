...
# (app/ — исходный Android-референс — УДАЛЁН: миграция завершена, весь функционал в shared)
```
...
(Миграция завершена; исходный `app/`-референс удалён — история в git, если нужна сверка.)
